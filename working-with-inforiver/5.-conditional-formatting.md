...
2. Creating advanced rules from scratch using nested if-conditions, ranking etc which are covered in [advanced options](5.-conditional-formatting/create-rule-basic-settings.md)
