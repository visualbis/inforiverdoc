...
{% hint style="info" %}
The Simulate option in the Insert ribbon is available only in the Inforiver Reporting Matrix. For creating simulations in Inforiver Writeback Matrix, refer to '[Scenarios](../7.-planning-budgeting-and-forecasting/scenarios-enterprise-only.md)'.
{% endhint %}
