...
Based on when you receive the actual data for a forecasted period, you can choose up to when you would like to close forecasts. In this example, we received the data for January 2024 in February 2024 - so we can select the 'Previous Month' option to close the forecast till January. If we receive data at the end of a particular month, we can choose 'Current Month', E.g., if we received January data by the end of the month, we would choose current month.

<figure><img src="../../../.gitbook/assets/image (1).png" alt=""><figcaption><p>Close period till option</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (2).png" alt=""><figcaption><p>Extend forecast range option</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (3).png" alt=""><figcaption><p>Duration by which to extned the forecast</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (4).png" alt=""><figcaption><p>Preview forecast</p></figcaption></figure>
