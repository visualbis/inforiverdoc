...
Inforiver Matrix is the best solution for collaborative planning and reporting in Power BI. When multiple people update the same report, approvals are essential for maintaining data integrity. You can set up approval workflows in Inforiver with scripts or leverage the intuitive user interface.
...
<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption><p>On Change Formula section</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (7).png" alt=""><figcaption><p>Sample email triggered usig the SENDMAIL function</p></figcaption></figure>

### 2. Approval workflow user interface
...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p>Adding and editing options</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption><p>Enter authorized email IDs</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>Creating workflows</p></figcaption></figure>

Repeat this step until all the required workflows have been created.

<figure><img src="../.gitbook/assets/image (4).png" alt=""><figcaption><p>Workflows created</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (6).png" alt=""><figcaption><p>Single select fields with underlying scripts are created automatically by Inforiver</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Untitled Project.gif" alt=""><figcaption><p>Staus changes for approvals</p></figcaption></figure>
