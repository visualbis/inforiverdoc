...
* [Working with Inforiver](working-with-inforiver/README.md)
  ...
  * [7. Planning, budgeting & forecasting](working-with-inforiver/7.-planning-budgeting-and-forecasting/README.md)
    ...
    * [Scenarios (Writeback Matrix only)](working-with-inforiver/7.-planning-budgeting-and-forecasting/scenarios-enterprise-only.md)
    ...
    * [Forecasting](working-with-inforiver/7.-planning-budgeting-and-forecasting/forecasting.md)
      ...
      * [Row level forecast](working-with-inforiver/7.-planning-budgeting-and-forecasting/forecasting/row-level-forecast.md)
  ...
  * [10. Exporting reports](working-with-inforiver/10.-exporting-reports/README.md)
    ...
    * [Snapshot (Writeback Matrix only)](working-with-inforiver/10.-exporting-reports/snapshot-writeback-matrix-only/README.md)
      * [Comparing snapshots](working-with-inforiver/10.-exporting-reports/snapshot-writeback-matrix-only/comparing-snapshots.md)
  ...
  * [12. Data writeback](working-with-inforiver/12.-data-writeback/README.md)
    ...
    * [Destinations](working-with-inforiver/12.-data-writeback/destinations/README.md)
      ...
      * [Fabric SQL](working-with-inforiver/12.-data-writeback/destinations/fabric-sql.md)
  ...
  * [18. Variables](working-with-inforiver/18.-variables/README.md)
    * [Variable types](working-with-inforiver/18.-variables/variable-types/README.md)
...
* [Admin Console](admin-console/README.md)
  ...
  * [User management](admin-console/user-management/README.md)
    * [User Roles and Permissions](admin-console/user-management/user-roles-and-permissions.md)
    * [Create custom roles and policies](admin-console/user-management/create-custom-roles-and-policies.md)
...
* [Formula syntax](formula-syntax/README.md)
  ...
  * [Math functions](formula-syntax/math-functions/README.md)
    ...
    * [NORMDIST](formula-syntax/math-functions/normdist.md)
    * [NORMSDIST](formula-syntax/math-functions/normsdist.md)
    * [NORMINV](formula-syntax/math-functions/norminv.md)
    * [NORMSINV](formula-syntax/math-functions/normsinv.md)
  ...
  * [Identifiers](formula-syntax/identifiers/README.md)
    ...
    * [FORECAST.CLOSED\_END](formula-syntax/identifiers/forecast.closed_end.md)
    * [FORECAST.CLOSED\_START](formula-syntax/identifiers/forecast.closed_start.md)
...
* [Infobridge](infobridge/README.md)
  * [1. Create bridge](infobridge/1.-create-bridge.md)
  * [2. Add source to bridge](infobridge/2.-add-source-to-bridge.md)
  * [3. Bridge Interface](infobridge/3.-bridge-interface.md)
  * [4. Manage queries](infobridge/4.-manage-queries/README.md)
  ...
  * [7. Manage Integration of visuals](infobridge/7.-manage-integration-of-visuals.md)
  * [8. Manage Bridges](infobridge/8.-manage-bridges.md)
  * [9. Data transformations](infobridge/9.-data-transformations/README.md)
    * [Pivot table](infobridge/9.-data-transformations/pivot-table.md)
    ...
    * [Sort](infobridge/9.-data-transformations/sort.md)
    ...
    * [Extract Comments](infobridge/9.-data-transformations/extract-comments.md)
...
* [Release Notes](release-notes/README.md)
  * [Inforiver Writeback Matrix April 2025 - v4.4.2](release-notes/inforiver-writeback-matrix-april-2025-v4.4.2.md)
