...
```javascript
AGGREGATE([Profit], SHIFT(CURRENT_PERIOD, "-1M"), SHIFT(CURRENT_PERIOD, "-3M"))
...
The AGGREGATE function has been used to find the minimum sales 3 months prior to the current date.

<figure><img src="../../.gitbook/assets/image.png" alt=""><figcaption><p>AGGREGATE</p></figcaption></figure>
